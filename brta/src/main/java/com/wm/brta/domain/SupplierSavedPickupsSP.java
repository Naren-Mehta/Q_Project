...
@Entity
@Table(name = "getsuppliersavedpickups")
public class SupplierSavedPickupsSP {
	...
	public String toString() {
		return "SupplierSavedPickupsSP [sequenceNo=" + sequenceNo
				+ ", customerSiteId=" + customerSiteId + ", customerId="
				+ customerId + ", siteName=" + siteName + ", houseNumber="
				+ houseNumber + ", address1=" + address1 + ", address2="
				+ address2 + ", address3=" + address3 + ", address4="
				+ address4 + ", address5=" + address5 + ", postCode="
				+ postCode + ", telNo=" + telNo + ", customerName="
				+ customerName + ", driver1Id=" + driver1Id + ", driver2Id="
				+ driver2Id + ", pickupDate=" + pickupDate
				+ ", driver1FirstName=" + driver1FirstName
				+ ", driver1MiddleName=" + driver1MiddleName
				+ ", driver1LastName=" + driver1LastName
				+ ", driver1MobilePhone=" + driver1MobilePhone
				+ ", driver1Email=" + driver1Email + ", driver2FirstName="
				+ driver2FirstName + ", driver2MiddleName=" + driver2MiddleName
				+ ", driver2LastName=" + driver2LastName
				+ ", driver2MobilePhone=" + driver2MobilePhone
				+ ", driver2Email=" + driver2Email + ", vehiclePlateNo="
				+ vehiclePlateNo + "]";
	}
